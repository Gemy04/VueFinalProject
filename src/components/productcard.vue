                ...
                <div class="product-grid">
                    <div class="product-image">
                        ...
                        <ul class="product-links">
                            <li><a href="#" @click="addToWishlist(product.id)"><i class="fa fa-heart"></i></a></li>
                            <li><a href="#" @click="addToCart(product.id)"><i class="fa fa-shopping-cart"></i></a></li>
                        </ul>
                    ...
                    <div class="product-content">
                        <ul class="rating">
                            <li v-for="i in 5" :class="i <= product.rating ? 'fas fa-star' : 'fas fa-star disable'"></li>
                        </ul>
